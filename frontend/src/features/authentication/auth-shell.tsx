...
export function AuthShell({
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-background flex flex-col">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_30%,_rgba(232,93,63,0.03),_transparent_40%)]" />
      <div className="relative mx-auto flex min-h-screen w-full max-w-7xl flex-col px-4 py-6 sm:px-6 lg:px-8 z-10">
        {/* Modern Nav Header */}
        <div className="flex items-center justify-between gap-4 rounded-2xl border border-border/40 bg-card/85 px-6 py-3 shadow-xs backdrop-blur-md">
          <div className="flex items-center gap-3">
            <div className="flex h-9 w-9 items-center justify-center rounded-xl overflow-hidden bg-card border border-border/40 shadow-xs">
              <img
        ...
        <div className="flex-1 flex items-center justify-center py-12 lg:py-16">
          <section className="w-full max-w-lg mx-auto">
            ...
            <Card className="border-border/40 bg-card/95 shadow-md backdrop-blur-md">
