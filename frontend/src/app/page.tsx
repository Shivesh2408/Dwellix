...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden font-sans relative">
      ...
      <div className="absolute top-0 right-[-10%] w-[900px] h-[900px] bg-gradient-to-br from-primary/10 to-[#C9785D]/5 rounded-full blur-[140px] pointer-events-none -z-10 translate-y-[-20%]" />
      <div className="absolute top-[300px] left-[-20%] w-[700px] h-[700px] bg-gradient-to-tr from-[#D89A45]/5 to-primary/5 rounded-full blur-[120px] pointer-events-none -z-10" />
      <div className="absolute top-[600px] right-[10%] w-[600px] h-[600px] bg-radial from-primary/5 to-transparent rounded-full blur-[120px] pointer-events-none -z-10" />
      ...
      >
        <nav className="w-full max-w-[1280px] h-20 rounded-[28px] border border-[#ECECEC] bg-white/70 backdrop-blur-xl px-10 flex items-center justify-between shadow-[0_8px_30px_rgb(0,0,0,0.02)]">
          ...
          <div className="hidden md:flex items-center gap-10 text-[15px] font-semibold text-[#6B7280]">
            ...
            <Link href="/resources" className="hover:text-[#111111] transition-colors tracking-tight">Resources</Link>
            <Link href="/about" className="hover:text-[#111111] transition-colors tracking-tight">About Us</Link>
          </div>
        ...
        <AnimatePresence>
          {mobileMenuOpen && (
            <motion.div 
              ...
              className="absolute top-24 left-4 right-4 md:top-32 md:left-8 md:right-8 bg-white border border-[#ECECEC] rounded-[32px] p-8 shadow-[0_24px_60px_rgba(0,0,0,0.08)] z-40 flex flex-col gap-5 text-left"
            >
              ...
              <Link href="/resources" onClick={() => setMobileMenuOpen(false)} className="text-base font-semibold py-2.5 border-b border-[#ECECEC] text-[#111111]">Resources</Link>
              <Link href="/about" onClick={() => setMobileMenuOpen(false)} className="text-base font-semibold py-2.5 text-[#111111]">About Us</Link>
      ...
      <main className="max-w-[1400px] mx-auto px-8 pt-48 pb-32 w-full flex flex-col justify-center gap-32">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-20 items-center w-full">
          ...
          <div className="lg:col-span-5 flex flex-col items-start text-left gap-8 z-10">
            <motion.div 
              ...
              initial="hidden"
              animate="visible"
              className="inline-flex items-center gap-2.5 px-4 py-2 rounded-full border border-primary/20 bg-primary-soft text-primary text-xs font-semibold tracking-wide"
            >
            ...
            <motion.h1 
              ...
              initial="hidden"
              animate="visible"
              className="text-[52px] sm:text-[76px] lg:text-[84px] font-extrabold tracking-[-0.06em] text-foreground leading-[0.9] -ml-1"
            >
              Your Home. <br />
            ...
            >
              <Link href="/auth/signup" className="w-full sm:w-auto">
                <button className="h-14 px-9 rounded-[20px] bg-primary text-white hover:bg-primary-hover active:scale-[0.98] font-semibold text-base transition-all shadow-[0_12px_40px_rgba(232,93,63,0.12)] hover:-translate-y-0.5 active:translate-y-0 w-full sm:w-auto cursor-pointer">
                  Get Started Free
                </button>
              </Link>
              <button className="h-14 px-9 rounded-[20px] bg-card border border-border text-foreground hover:bg-secondary font-semibold text-base transition-all shadow-[0_12px_40px_rgba(63,43,35,0.02)] hover:-translate-y-0.5 active:translate-y-0 flex items-center justify-center gap-2.5 w-full sm:w-auto cursor-pointer">
                <Play className="h-4.5 w-4.5 fill-foreground text-foreground ml-0.5" />
                Watch Demo
              </button>
            </motion.div>
          ...
          >
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[550px] h-[550px] bg-radial-gradient from-primary/10 to-transparent blur-3xl rounded-full pointer-events-none -z-10" />

            {/* MacOS Window Container */}
            <div className="w-full rounded-[32px] border border-border bg-card p-3 shadow-lg overflow-hidden relative select-none">
              
              {/* macOS Window Controls */}
              <div className="h-12 px-6 flex items-center justify-between border-b border-border bg-secondary rounded-t-[20px]">
                ...
                <span className="text-xs font-semibold text-muted-foreground tracking-tight">Dwellix Portal</span>
                <div className="w-12" />
              </div>

              {/* Dynamic Live CSS Dashboard Layout */}
              <div className="w-full bg-background rounded-b-[20px] overflow-hidden flex text-left font-sans text-xs select-none">
                
                {/* Mini Sidebar */}
                <div className="w-[180px] bg-card border-r border-border p-4 flex flex-col justify-between hidden sm:flex shrink-0">
                  <div className="space-y-6">
                    <div className="flex items-center gap-2.5 px-1 py-1">
                      ...
                      <span className="font-extrabold text-[13px] tracking-tight text-foreground">Dwellix</span>
                    </div>

                    <div className="space-y-1.5">
                      <div className="flex items-center gap-2 px-2.5 py-2 rounded-xl bg-primary-soft text-primary font-bold">
                        <LayoutDashboard className="h-4 w-4" />
                        Dashboard
                      </div>
                      <div className="flex items-center gap-2 px-2.5 py-2 rounded-xl text-muted-foreground font-semibold hover:bg-secondary transition-colors">
                  ...
                  <div className="space-y-2 pt-8 border-t border-border">
                    <div className="flex items-center gap-2 px-2.5 py-1.5 rounded-xl text-muted-foreground font-semibold">
                ...
                {/* Dashboard Viewport */}
                <div className="flex-1 p-5 space-y-5 bg-background min-h-[380px] overflow-hidden">
                  
                  {/* Viewport Header */}
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      <h4 className="font-bold text-[14px] text-foreground">Overview</h4>
                      <p className="text-[10px] text-muted-foreground font-medium">Smart status is active</p>
                    </div>
                    <div className="flex items-center gap-2">
                      <div className="h-7 w-7 rounded-lg bg-card border border-border flex items-center justify-center text-muted-foreground">
                        <Bell className="h-3.5 w-3.5" />
                      </div>
                      <div className="h-7 w-7 rounded-lg bg-primary text-white flex items-center justify-center font-bold text-[11px] shadow-sm">
                        JD
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    {[
                      { l: "Appliances", v: "14", c: "bg-card text-foreground" },
                      { l: "Active Coverages", v: "11", c: "bg-card text-foreground" },
                      { l: "Service Alerts", v: "0", c: "bg-card text-emerald-600" }
                    ].map((s, idx) => (
                      <div key={idx} className={`${s.c} border border-border rounded-xl p-3.5 shadow-sm`}>
                        <div className="text-[9px] text-muted-foreground font-bold uppercase tracking-wider">{s.l}</div>
                        <div className="text-lg font-black mt-1">{s.v}</div>
                      </div>
                    ))}
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-12 gap-4">
                    ...
                    {/* Device Statuses */}
                    <div className="sm:col-span-7 bg-card border border-border rounded-2xl p-4 shadow-sm space-y-3 text-left">
                      <div className="font-bold text-[11px] text-foreground border-b border-background pb-1.5 flex justify-between items-center">
                        <span>Appliances</span>
                        <span className="text-[10px] text-primary font-semibold cursor-pointer">View All</span>
                      </div>
                      <div className="space-y-2">
                        {[
                          ...
                          <div key={idx} className="flex items-center justify-between py-1 border-b border-background last:border-0">
                            <div>
                              <div className="font-bold text-[10px] text-foreground">{d.name}</div>
                              <div className="text-[9px] text-muted-foreground mt-0.5">{d.status}</div>
                            </div>
                    ...
                    {/* AI Chat insight */}
                    <div className="sm:col-span-5 bg-card border border-border rounded-2xl p-4 shadow-sm flex flex-col justify-between">
                      <div className="space-y-2">
              ...
              {/* Top-Left Widget */}
              <div className="absolute top-10 left-[-40px] bg-card/85 backdrop-blur-md rounded-[20px] border border-border/60 px-4 py-3 shadow-md flex items-center gap-3 scale-90 sm:scale-100 origin-left">
                <div className="h-9 w-9 rounded-xl bg-primary-soft text-primary flex items-center justify-center">
                  <Sparkles className="h-4.5 w-4.5" />
                </div>
                <div className="text-left">
                  <div className="text-xs font-bold text-foreground tracking-tight">Active Diagnostics</div>
                  <div className="text-[10px] text-muted-foreground font-semibold mt-0.5">Monitoring Active</div>
                </div>
              </div>

              {/* Bottom-Right Widget */}
              <div className="absolute bottom-12 right-[-30px] bg-[#2B2421]/95 backdrop-blur-md rounded-[20px] border border-[#3F332E]/30 p-4 shadow-lg text-white flex items-center gap-3.5 scale-90 sm:scale-100 origin-right">
        ...
        <div className="pt-24 border-t border-border w-full text-left space-y-16">
          
          {/* Monochrome partner logos */}
          <div className="space-y-6">
            <p className="text-[11px] font-bold text-muted-foreground uppercase tracking-[0.25em]">Trusted by verified modern homeowners</p>
            <div className="flex flex-wrap items-center justify-between gap-8 opacity-35 grayscale py-4">
              {trustedBrands.map((brand, idx) => (
                <span key={idx} className="font-heading font-extrabold text-2xl sm:text-3xl tracking-tighter text-foreground hover:opacity-100 transition-opacity duration-300">
                  {brand}
                </span>
              ))}
            </div>
            ...
            {[
              ...
              return (
                <motion.div
                  ...
                  whileHover={{ y: -8, boxShadow: "0 16px 50px rgba(63, 43, 35, 0.08)" }}
                  className="rounded-[28px] border border-border bg-card p-8 shadow-sm transition-all duration-300 flex flex-col justify-between min-h-[240px]"
                >
                  <div className="space-y-6">
                    ...
                    <div className="space-y-1">
                      ...
                      <div className="text-3xl sm:text-4xl font-extrabold tracking-tight text-foreground">{card.value}</div>
                    </div>
                  </div>
                  <p className="text-[13px] text-muted-foreground leading-relaxed mt-5 font-medium">{card.desc}</p>
                </motion.div>
              );
            })}
          </motion.div>
